...
public enum Fragments {  //枚举类型在枚举类中直接实例化实例
    ...
    ONE(FragmentOne.class),
    TWO(FragmentTwo.class),
    THREE(FragmentThree.class),
    ABOUT(FragmentAbout.class),
    HealthKnowledge(HealthKnowledgeFragment.class),
    MyHealth(MyHealthFragment.class),
    ConsIdenty(ConsIdentyFragment.class),
    MyDevices(MyDevicesFragment.class),
    HealthData(HealthDataFragement.class),
    MyConstitutionFragment(MyConstitutionFragment.class),
    MyConstitute(MycontitutehistoryFragment.class),
    HealthSuggestion(HealthSuggestionFragment.class),
    HealthTending(HealthTendingFragment.class),
    HealthWarning(HealthWarningFragment.class),
    MyCollection(MyCollectionFragment.class),
    HealthSuggestionCollection(HeleathSuggestionCollectionFragment.class),
